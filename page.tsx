  ...
  return (
    <div className="bg-gradient-to-b from-blue-50 to-white py-12 px-4">
      <div className="max-w-5xl mx-auto text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-3">Free Business Calculators</h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-6">
          Simple, fast tools for pricing, profit, tax, ROI, and everyday business decisions.
        </p>
        <Link href="#calculators" className="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition">
          Start Calculating
        </Link>
      </div>

      <div id="calculators" className="max-w-5xl mx-auto">
        <h2 className="text-2xl font-semibold text-gray-800 mb-6">Free Business Calculators</h2>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {calculators.map((calc) => (
            <Link key={calc.href} href={calc.href} className="bg-white rounded-2xl shadow p-6 hover:shadow-lg transition border border-gray-200">
      ...
      <section className="max-w-5xl mx-auto mt-16 text-gray-700">
        <h2 className="text-2xl font-semibold mb-4">Why Use These Business Calculators?</h2>
        <p>
          Whether you’re a freelancer setting your rates, an entrepreneur evaluating a project, or a small business owner planning pricing, these tools help you understand your numbers quickly. All calculators are free, easy to use, and work on any device.
        </p>
      </section>
    </div>
  );
